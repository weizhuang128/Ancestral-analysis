...
#import re
me23 = open(r'23andme_V5_template.txt')
new_me23 = open('new_me23.txt', 'wb+')
new_me23.write('''# This data file generated by 23andMe at: Tue Mar 06 14:38:12 2018
#
...
# https://you.23andme.com/p/f8bcead4e0ed3827/tools/data/download/
# 
...
for me23_line in me23:
    ...
    if me23_rsid in mofang23:
        ...
        if not ('I' or 'D') in mofang23_genotype:
            if ('--' or '-') in me23_line:
...
Matched_NO_display['text'] = 'Matched SNPs number is ',matchNO
...
#pool.close()
#pool.join()
# pyinstaller -F D:\Users\weizhuang\PycharmProjects\untitled\23mofang223me.py build the py -w can move the CMD interface but will be recognized as a virus
#print matchNO
